...
const struct clever_instruction_info clever_insns[] = {
    {0x000, 0x000, 0, XMain, "und",  validate_allow_any, noop_print_h, add_none, add_none,validate_any_ops, NULL, NULL},
    {0x001, 0x400, 2, XMain, "add",  validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS+1],&clever_insns[ARITH_GPR_SRC_SPECS+1]},
    {0x002, 0x400, 2, XMain, "sub",  validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS+1],&clever_insns[ARITH_GPR_SRC_SPECS+1]},
    {0x003, 0x400, 2, XMain, "and",  validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS+1],&clever_insns[ARITH_GPR_SRC_SPECS+1]},
    {0x004, 0x400, 2, XMain, "or" ,  validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS+1],&clever_insns[ARITH_GPR_SRC_SPECS+1]},
    {0x005, 0x400, 2, XMain, "xor",  validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS+1],&clever_insns[ARITH_GPR_SRC_SPECS+1]},
    ...
    {0x008, 0x400, 2, XMain, "mov",  validate_allow_none, noop_print_h, add_none, add_none, validate_mov, &clever_insns[10], &clever_insns[11]},
    {0x009, 0x000, 2, XMain, "lea",  validate_allow_none, noop_print_h, add_none, add_none, validate_lea, &clever_insns[12], NULL},
    {0x00A, 0x400, 1, XMain, "mov",  validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_mov, NULL, NULL},
    {0x00B, 0x400, 1, XMain, "mov",  validate_allow_any, noop_print_h, add_none, add_implied_gpr, validate_mov, NULL, NULL},
    {0x00C, 0x000, 1, XMain, "lea",  validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_lea, NULL, NULL},

    {0x010, 0x000, 0, XMain, "nop",  validate_allow_any, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x011, 0x000, 1, XMain, "nop",  validate_allow_any, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x012, 0x000, 2, XMain, "nop",  validate_allow_any, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x013, 0x000, 3, XMain, "nop",  validate_allow_any, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},

    {0x014, 0x000, 1, XMain, "push",  validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, &clever_insns[18], NULL},
    {0x015, 0x000, 1, XMain, "pop" ,  validate_allow_none, noop_print_h, add_none, add_none, validate_pop, &clever_insns[19], NULL},
    {0x016, 0x000, 0, XMain, "push",  validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_any_ops, NULL, NULL},
    {0x017, 0x000, 0, XMain, "pop" ,  validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_pop, NULL, NULL},
    ...
    {0x028, 0x000, prefix, XMain, "repbi", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x029, 0x000, prefix, XMain, "repbc", validate_allow_any, print_cc_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x02A, 0x028, 0, XMain, "bcpy", validate_allow_ss, noop_print_h, add_block_mem_refs, add_none, validate_block_mem_refs, NULL, NULL},
    {0x02B, 0x028, 0, XMain, "bsto", validate_allow_ss, noop_print_h, add_block_mem_refs, add_none, validate_block_mem_refs, NULL, NULL},
    {0x02C, 0x028, 0, XMain, "bsca", validate_allow_ss, noop_print_h, add_block_mem_refs, add_none, validate_block_mem_refs, NULL, NULL},
    {0x02D, 0x028, 0, XMain, "bcmp", validate_allow_ss, noop_print_h, add_block_mem_refs, add_none, validate_block_mem_refs, NULL, NULL},
    {0x02E, 0x028, 0, XMain, "btst", validate_allow_ss, noop_print_h, add_block_mem_refs, add_none, validate_block_mem_refs, NULL, NULL},

    {0x030, 0x400, 2, XMain, "lsh",  validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS-7], NULL},
    {0x031, 0x400, 2, XMain, "rsh",  validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS-6], NULL},
    {0x032, 0x400, 2, XMain, "arsh", validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS-5], NULL},
    {0x033, 0x400, 2, XMain, "lshc", validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS-4], NULL},
    {0x034, 0x400, 2, XMain, "rshc", validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS-3], NULL},
    {0x035, 0x400, 2, XMain, "lrot", validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS-2], NULL},
    {0x036, 0x400, 2, XMain, "rrot", validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_arith_insn, &clever_insns[ARITH_GPR_DEST_SPECS-1], NULL},
    {0x038, 0x400, 1, XMain, "lsh",  validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x039, 0x400, 1, XMain, "rsh",  validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x03A, 0x400, 1, XMain, "arsh", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x03B, 0x400, 1, XMain, "lshc", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x03C, 0x400, 1, XMain, "rshc", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x03D, 0x400, 1, XMain, "lrot", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x03E, 0x400, 1, XMain, "rrot", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},

    {0x040, 0x000, 0, XMain, "imul", validate_mul_insn, add_mul_ssf, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x041, 0x400, 1, XMain, "add", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x042, 0x400, 1, XMain, "sub", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x043, 0x400, 1, XMain, "and", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x044, 0x400, 1, XMain, "or" , validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x045, 0x400, 1, XMain, "xor", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_arith_insn, NULL, NULL},
    {0x046, 0x400, 1, XMain, "bnot",validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_unary_arith_insn, &clever_insns[ARITH_GPR_SRC_SPECS+6], NULL},
    {0x047, 0x400, 1, XMain, "neg", validate_arith_mem_h, add_arith_lf_h, add_none, add_none, validate_unary_arith_insn, &clever_insns[ARITH_GPR_SRC_SPECS+7], NULL},
    {0x048, 0x400, 0, XMain, "idiv", validate_allow_any, add_div_sswf, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x049, 0x400, 1, XMain, "add", validate_allow_any, noop_print_h, add_none, add_implied_gpr, validate_arith_insn, NULL, NULL},
    {0x04A, 0x400, 1, XMain, "sub", validate_allow_any, noop_print_h, add_none, add_implied_gpr, validate_arith_insn, NULL, NULL},
    {0x04B, 0x400, 1, XMain, "and", validate_allow_any, noop_print_h, add_none, add_implied_gpr, validate_arith_insn, NULL, NULL},
    {0x04C, 0x400, 1, XMain, "or" , validate_allow_any, noop_print_h, add_none, add_implied_gpr, validate_arith_insn, NULL, NULL},
    {0x04D, 0x400, 1, XMain, "xor", validate_allow_any, noop_print_h, add_none, add_implied_gpr, validate_arith_insn, NULL, NULL},
    {0x04E, 0x400, 0, XMain, "bnot", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_unary_arith_insn, NULL, NULL},
    {0x04F, 0x400, 0, XMain, "neg", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_unary_arith_insn, NULL, NULL},
    
    {0x06c, 0x000, 2, XMain, "cmp", validate_allow_none, noop_print_h, add_none, add_none, validate_cmp_insn, &clever_insns[CMP_GPR_SPEC], NULL},
    {0x06d, 0x000, 2, XMain, "test", validate_allow_none, noop_print_h, add_none, add_none, validate_cmp_insn, &clever_insns[CMP_GPR_SPEC], NULL},
    {0x06e, 0x000, 1, XMain, "cmp", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_cmp_insn, &clever_insns[CMP_GPR_SPEC], NULL},
    {0x06f, 0x000, 1, XMain, "test", validate_allow_any, noop_print_h, add_implied_gpr, add_none, validate_cmp_insn, &clever_insns[CMP_GPR_SPEC], NULL},

    {0x100, 0x400, 1, XFloat, "round", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x101, 0x400, 1, XFloat, "ceil", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x102, 0x400, 1, XFloat, "floor", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x103, 0x400, 1, XFloat, "fabs", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x104, 0x400, 1, XFloat, "fneg", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x105, 0x400, 1, XFloat, "finv", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x106, 0x400, 2, XFloat, "fadd", validate_flags_only, print_flags_h, add_none, add_none, validate_float_binop, NULL, NULL},
    {0x107, 0x400, 2, XFloat, "fsub", validate_flags_only, print_flags_h, add_none, add_none, validate_float_binop, NULL, NULL},
    {0x108, 0x400, 2, XFloat, "fmul", validate_flags_only, print_flags_h, add_none, add_none, validate_float_binop, NULL, NULL},
    {0x109, 0x400, 2, XFloat, "fdiv", validate_flags_only, print_flags_h, add_none, add_none, validate_float_binop, NULL, NULL},
    {0x10A, 0x400, 2, XFloat, "frem", validate_flags_only, print_flags_h, add_none, add_none, validate_float_binop, NULL, NULL},
    {0x10B, 0x400, 3, XFloat, "ffma", validate_flags_only, print_flags_h, add_none, add_none, validate_float_top, NULL, NULL},

    {0x118, 0x000, 1, XFloat, "fcmpz", validate_allow_none, noop_print_h, add_none, add_none, validate_float_cmpz, NULL, NULL},
    {0x119, 0x000, 2, XFloat, "fcmp" , validate_allow_none, noop_print_h, add_none, add_none, validate_float_cmp, NULL, NULL},
    
    {0x120, 0x400, 1, XFloatExt, "exp", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x121, 0x400, 1, XFloatExt, "ln" , validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x122, 0x400, 1, XFloatExt, "lg" , validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x123, 0x400, 1, XFloatExt, "sin", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x124, 0x400, 1, XFloatExt, "cos", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x125, 0x400, 1, XFloatExt, "tan", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x126, 0x400, 1, XFloatExt, "asin", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x127, 0x400, 1, XFloatExt, "acos", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x128, 0x400, 1, XFloatExt, "atan", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x129, 0x400, 1, XFloatExt, "exp2", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x12A, 0x400, 1, XFloatExt, "log10", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x12B, 0x400, 1, XFloatExt, "lnp1", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x12C, 0x400, 1, XFloatExt, "expm1", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},
    {0x12D, 0x400, 1, XFloatExt, "sqrt", validate_flags_only, print_flags_h, add_none, add_none, validate_float_unop, NULL, NULL},

    {0x130, 0x000, 0, XFloat, "fraiseexcept", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x131, 0x000, 0, XFloat, "fraiseexcept", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    
    {0x200, 0x000, 2, XMain, "xchg",validate_allow_none, noop_print_h, add_none, add_none, validate_xhcg, NULL, NULL},
    {0x201, 0x000, 3, XMain, "cmpxchg", validate_allow_none, noop_print_h, add_none, add_none, validate_cmpxchg, NULL, NULL},
    {0x202, 0x000, 3, XMain, "wcmpxchg", validate_allow_none, noop_print_h, add_none, add_none, validate_cmpxchg, NULL, NULL},
    {0x203, 0x000, 0, XMain, "fence", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    
    {0x230, 0x000, 0, XRand, "rdpoll", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},

    {0x400, 0x000, prefix, XVec, "vec", validate_allow_ss, print_ss_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x401, 0x000, 2, XVec, "vmov", validate_allow_none, noop_print_h, add_none, add_none, validate_vmov, NULL, NULL},

    {0x801, 0x000, 0, XMain, "halt", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x802, 0x000, 0, XMain, "pcfl", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x803, 0x000, 0, XMain, "flall", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x804, 0x000, 1, XMain, "dflush", validate_allow_none, noop_print_h, add_none, add_none, validate_needs_mem, NULL, NULL},
    {0x805, 0x000, 1, XMain, "iflush", validate_allow_none, noop_print_h, add_none, add_none, validate_needs_mem, NULL, NULL},
    {0x806, 0x028, 0, XMain, "in", validate_allow_ss, print_ss_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x807, 0x028, 0, XMain, "out", validate_allow_ss, print_ss_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0x808, 0x000, 1, XMain, "storegf", validate_allow_none, noop_print_h, add_none, add_none, validate_needs_mem, NULL, NULL},
    {0x809, 0x000, 1, XMain, "rstregf", validate_allow_none, noop_print_h, add_none, add_none, validate_needs_mem, NULL, NULL},
    {0xe00, 0x000, 0, XVirtualization, "vmcreate", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0xe01, 0x000, 0, XVirtualization, "vmdestroy", validate_allow_none, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
    {0xfff, 0x000, 0, XMain, "und", validate_allow_any, noop_print_h, add_none, add_none, validate_any_ops, NULL, NULL},
